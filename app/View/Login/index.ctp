...
<div class="row">
  ...
  <div class="large-5 columns panel radius padding">
   ...
   <!--     <div class="row">
          <div class="small-3 columns">
            <label for="password" class="right inline">Verify</label>
          </div>


          <div class="small-6 columns">
            <input type="hidden" value="<?php echo $captchaid; ?>" name="captchaId"/>
            <img src="<?php echo $installation_root ?>/securimage/captcha_display.php?captchaId=<?php echo $captchaid; ?>" />
          </div>

          <div class="small-3 columns">
              <input type="password" name="captcha_code"/>
          </div>
